...
//       if (data.feedback) {
//         try {
//           const parsedFeedback: CompleteFeedbackData = JSON.parse(data.feedback);
...
//           if (parsedFeedback.suggestions && parsedFeedback.suggestions.length > 0) {
...
//           <p className="text-blue-600 dark:text-blue-400">Loading feedback data...</p>
//         </div>
//       )}
...
//                 style={{ width: `${(Number(score) / Number(totalPossibleScore)) * 100}%` }}
//               ></div>
//             </div>
//           </div>
//         )}
...
//       {criteria && (
//         <>
//           <p className="mt-4 text-sm text-gray-600">Sub-Scores (out of 10):</p>
...
//           <p className="text-gray-500 italic">No suggestions yet. Generate feedback to see suggestions.</p>
//         ) : (
//           suggestions.map((sug) => (
//             <div
//               key={sug.id}
//               className={`p-3 border rounded mb-2 transition-colors ${
//                 sug.resolved ? "bg-green-50 dark:bg-green-900/30 border-green-200" : 
//                 sug.markSchemeReference ? "bg-blue-50 dark:bg-blue-900/30 border-blue-200" : "bg-white dark:bg-darker-custom hover:bg-gray-50"
//               }`}
...
//                   <strong className={sug.resolved ? "line-through text-gray-500" : ""}>
//                     Suggestion:
//                   </strong>{" "}
//                   <span className={sug.resolved ? "line-through text-gray-500" : ""}>
//                     {sug.advice}
//                   </span>

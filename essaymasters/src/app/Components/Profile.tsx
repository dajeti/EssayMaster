...
return (
    <div>
        <button onClick={toggleDropdown}
            className="flex items-center space-x-2 h-full px-4 py-2 hover:underline focus:outline-none"
        >
        ...
        {isDropdownOpen && (
            <div className="absolute-left-1/2 mt-1 w-48 bg-white shadow-lg rounded-lg border border-gray-100 translate-x-7">
